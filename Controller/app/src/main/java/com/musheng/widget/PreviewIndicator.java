...
import com.musheng.util.SystemUtil;
...
public class PreviewIndicator extends LinearLayout {
    ...
    public void initSize(int chosedSize,int nomal,int hei) {
       ...
       /* chooseSize = SystemUtil.dip2px(getContext(),chosedSize);
        nomalSize = DensityUtil.dip2px(getContext(),nomal);
        height = DensityUtil.dip2px(getContext(),hei);*/
    }
